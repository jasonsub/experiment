...
statements:statement	{reduce(specpoly,ideal);clear();}
	...
	;
statement:
	vardelc ';' ignoreWordDecl ';' minpoly ';' specPoly ';' polys ';'
	;

ignoreWordDecl: var {free($1);}
	| ignoreWordDecl ',' var {free($3);}
	;
