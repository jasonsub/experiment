...
area. 
%Efficient implementation of ROBDDs as a software package
...
%Manipulation of Boolean functions can then be carried
%out as composition operations on their respective DAGs. 
