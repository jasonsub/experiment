...
the worst case computation time/space cost of its Gr\"obner basis is doubly exponential while the total degree of 
...
\begin{Theorem}[Weak Nullstellensatz in $\Fq$]
\label{wnull:ff}
\cite{null:1890}
