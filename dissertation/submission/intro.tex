...
One way to perform verification is by simulation, which is the collage of all circuit validation 
...
verify the correctness of final reached state, i.e., the functional correctness of
