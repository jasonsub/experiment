...
The above algorithm describes a breath-first-search (BFS) traversal in
...
In order to throw light on the advantages of using word-level techniques, we pick a typical 
